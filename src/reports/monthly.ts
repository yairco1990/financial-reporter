...
export async function generateMonthlyReport(transactions: Transaction[], month: string): Promise<void> {
...
## Task
Generate a monthly financial report in Hebrew. Wrap in <div dir="rtl">...</div>.
...
Keep it concise and data-driven. Every number comes from the data above — do not invent numbers.`;
  ...
  const mdPath = path.join(reportDir, `${month}.md`);
